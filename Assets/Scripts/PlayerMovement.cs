...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(KeyCode.Space) || Input.GetKeyUp(KeyCode.C) || Input.GetKeyUp(KeyCode.J)) OnJumpUpInput();
    ...
    void FixedUpdate()
    {
        ...
        else if (_isDashAttacking) { Run(Data.dashEndRunLerp); }
    ...
    int _lastWallJumpDir;

    //Dash
    int _dashesLeft;
    bool _dashRefilling;
    Vector2 _lastDashDir;
    ...
    IEnumerator StartDash(Vector2 dir)
    {
        ...
        while (Time.time - startTime <= Data.dashEndTime) yield return null;
