...
// #endregion
//
// [RequireComponent(typeof(Collider2D))] public class CollectibleManager : MonoBehaviour
// {
//     /// <summary>
...
//     [Header("Ammo List and Adjustments")]
//     [Tooltip("The ammo types that can be collected")]
//     [Space(5)]
//     [SerializeField]
//     List<GameObject> ammoValues = new List<GameObject>();
//     [Header("List of Collectible GameObjects")]
//     [Tooltip("The list of all collectible GameObjects in the scene.")]
//     [Space(5)]
//     [SerializeField]
//     List<GameObject> collectibles = new List<GameObject>();
//
//     [Header("Ammo Text and Count")] [Tooltip("The text that displays the player's ammo count")] [SerializeField]
//     TextMeshProUGUI ammoText;
//     [SerializeField] int ammoStartCount;
//     [SerializeField] int ammoCount; // Alternatively, use your own ammo count variable.
//
//     [Header("Debugging")] [Tooltip("Used for debugging in the editor")] [SerializeField] bool debug;
//
//     void Start()
//     {
//         ammoCount = Mathf.Max(
